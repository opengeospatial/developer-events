...
.Selecting a metadata record on GeM+
image::../images/gemplus_1.png[align="center",width=800]

.Displaying a metadata record on GeM+
image::../images/gemplus_2.png[align="center",width=800]
