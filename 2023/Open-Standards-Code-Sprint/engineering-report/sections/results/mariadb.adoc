...
<<img_mariadb_tep_find_related_processes>> illustrates how the user selects one of the images and how the catalog is accessed to find compatible process (the Ship Detection Process in this case).
